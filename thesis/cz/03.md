...
![\\theta\^{\*}](http://chart.apis.google.com/chart?cht=tx&chl=%5Ctheta%5E%7B%2A%7D "\theta^{*}"),
spočítáme pravděpodobnost jejího přijetí<span
id="fnref17">\[^17^\](\#fn17)</span>:
...
![x\\sim\\mathrm{U}\\mathrm{\\text{nif}}\\left( 0,1
\\right)](http://chart.apis.google.com/chart?cht=tx&chl=x%5Csim%5Cmathrm%7BU%7D%5Cmathrm%7B%5Ctext%7Bnif%7D%7D%5Cleft%28%200%2C1%20%5Cright%29 "x\sim\mathrm{U}\mathrm{\text{nif}}\left( 0,1 \right)")
a zvolíme hodnotu nového vzorku:
...
trojice<span id="fnref18">\[^18^\](\#fn18)</span>) a archimédovský axiom
...
id="fnref20">\[^20^\](\#fn20)</span> – je mnoho důvodů:
...
17. V praxi samozřejmě používáme log-likelihood, kvůli lepším výpočetním
    charakteristikám; použití likelihood vede k součinům mnoha hodnot
    menších než jedna, a brzy bychom narazili na omezenou přesnost
    reprezentace takových čísel.[↩](#fnref17)

18. Viz. kapitolu X.[↩](#fnref18)

19. Viz kapitolu X.[↩](#fnref19)

20. Slovo počítač dle mého názoru příliš evokuje klasický desktop –
    ...
    tablety, telefony či e-inkové čtečky.[↩](#fnref20)
