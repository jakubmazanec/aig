...
id="fnref2">\[^2^\](\#fn2)</span> měřícího nástroje; na abstraktní
úrovni jsou výsledky vědomostní tvrzení o stavu měřeného objektu; často
mají formu: veličina *Q* asociovaná s objektem *O* má hodnotu *q*
s nejistotou *U*.
...
id="fnref4">\[^4^\](\#fn4)</span>, položil v jejím úvodu dvě otázky,
...
id="fnref6">\[^6^\](\#fn6)</span>: výsledek porovnání musí zůstat
...
rozlišení<span id="fnref7">\[^7^\](\#fn7)</span>: různé objekty mohou
...
1901<span id="fnref10">\[^10^\](\#fn10)</span> představuje
...
id="fnref14">\[^14^\](\#fn14)</span> z roku 1946 je jedním
z nejvlivnějších a přitom nejkontroverznějších<span
id="fnref15">\[^15^\](\#fn15)</span> textů k tématu měření. Stevens
...
extensive quantities*<span id="fnref16">\[^16^\](\#fn16)</span>, ve
...
zahrnují mereologicky<span id="fnref19">\[^19^\](\#fn19)</span>
...
1.  Ve starší anglické literatuře se termín *magnitude* používal jak ve
...
2.  „Hodnota veličiny poskytnutá měřidlem nebo měřicím systémem“
    \[22\], např. pozice ručičky ukazatele, číslice na displeji,
    zaškrtnuté odpovědi v dotazníku, apod.[↩](#fnref2)

3.  Relační systém je uspořádaná n-tice množin: ![\\mathcal{S =}\\left(
...
4.  „Počítání a měření z epistemologického hlediska“; není-li uvedeno
    jinak, je popis původního díla (\[29\]) podle anglického překladu
    (\[30\]).[↩](#fnref4)

5.  \[TODO: definice\][↩](#fnref5)

6.  \[TODO: definice\][↩](#fnref6)

7.  To je obvyklá námitka proti podobným empirickým relacím, a bude
    ještě několikrát zmíněna, především v kapitole \[?\].[↩](#fnref7)

8.  \[TODO: definice\][↩](#fnref8)

9.  \[TODO: definice\][↩](#fnref9)

10. „Axiomy veličin a teorie měření“; není-li uvedeno jinak, je popis
    původního díla (\[31\]) podle anglického překladu (\[12,
    13\]).[↩](#fnref10)

11. „Fyzika: základy“; není-li uvedeno jinak, je popis s použitím
    původního díla (\[29\]).[↩](#fnref11)

12. \[TODO: Campbell má divné pojetí čísel. Vysvětlit
    více?\][↩](#fnref12)

13. \[TODO: definice\][↩](#fnref13)

14. „O teorii škál měření“; není-li uvedeno jinak, je popis s použitím
    původního díla (\[32\]).[↩](#fnref14)

15. Více viz kapitolu \[?\][↩](#fnref15)

16. „Množina nezávislých axiomů pro extenzivní veličiny“; není-li
    uvedeno jinak, je popis s použitím původního díla
    (\[33\]).[↩](#fnref16)

17. \[TODO: před nimi ještě jeden Francouz. Dohledat!\][↩](#fnref17)

18. „Simultánní spojené měření: nový druh fundamentálního měření“;
    není-li uvedeno jinak, je popis s použitím původního díla
    (\[20\]).[↩](#fnref18)

19. \[TODO: definice\][↩](#fnref19)

20. Více viz kapitola \[?\][↩](#fnref20)
