...
(*a*, *p*) ≽ (*b*, *q*) právě tehdy když *f*(*a*, *p*)) ≥ f((*b*, *q*)).
...
takové, aby když je *E* splní, tak existuje *f<sub>1</sub>*
z *A<sub>1</sub>* do *N*, *f<sub>2</sub>* z *A<sub>2</sub>* do *N* a *F*
z *N*×*N* do *N* tak, že *f*((*a*, *p*)) = *F*(*f<sub>1</sub>*(a),
*f<sub>2</sub>*(p)), totiž (*a*, *p*) ≽ (*b*, *q*) právě tehdy když
*F*(*f<sub>1</sub>*(*a*), *f<sub>2</sub>*(*p*)) ≥
...
*f<sub>1</sub>* a f2 jsou potom intervalové škály související určitým
způsobem.
...
Na základě předchozí analýzy \[61\] navrhuje, že objektivita a
...
je komplexní, na modelu založený cílený proces, \[61\] navrhuje
...
strukturálně ekvivalentních činností. Interpretuje měření jako
...
produkovaly výsledky měření (\[VIM\]). Jádrem měřicího systému je
obvykle transduktor, který převádí vstupní vlastnosti do výstupní
